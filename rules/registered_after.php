...
class registered_after extends rule_base implements rule_interface
{
	...
	{
		return $this->api->lang('RULE_REGISTERED_AFTER');
	}
	...
	public function isTrue($conditions)
	{
		...
		$reference = gmmktime(23, 59, 59, $date[1], $date[0], $date[2]);
