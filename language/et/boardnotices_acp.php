...
$lang = array_merge($lang, array(
	...
	'LABEL_BOARD_NOTICE_RESET_EXPLAIN'		=> 'After this many days, the notice will be diplayed back to the users who dismissed it. Keep the field blank if you never want it to reappear.', // @todo
