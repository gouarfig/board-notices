...
class has_posted_more_test extends rule_test_base
{
	...
	{
		$api = new mock_api();
		$rule = new has_posted_more($this->getSerializer(), $api);
	...
	public function getTestData()
	{
		...
		return array(
			...
			array(73, 63, true),
			array(73, serialize(63), true),
			array(73, serialize(array(63)), true),
			array(73, $serializer->encode(63), true),
			array(73, $serializer->encode(array(63)), true),
		);
	}
