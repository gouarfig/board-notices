...
class has_posted_exactly_test extends \phpbb_test_case
{
	public function testInstance()
	{
		...
		$rule = new has_posted_exactly($user);
	...
	public function testGetDisplayName($args)
	{
		...
		$this->assertTrue((strpos($display, "posts equals") !== false), "Wrong DisplayName: '{$display}'");
	}
